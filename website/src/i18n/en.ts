export default {
  ...
  "feature.api.desc": "250+ exported functions with opaque handle-based design. Callable from any language — no C++ exposure.",
  ...
  "gs.minimalDesc": "Create a window with a label and a button using the pure C API. All 250+ functions use opaque uint64_t handles — no C++ headers needed.",
  ...
  "markup.reactiveMenuTitle": "Reactive Menus (1.6.0)",
