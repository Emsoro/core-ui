export default {
  ...
  "feature.api.desc": "250+ 个导出函数，基于不透明句柄设计。可从任何语言调用 — 无 C++ 暴露。",
  ...
  "gs.minimalDesc": "使用纯 C API 创建一个包含标签和按钮的窗口。所有 250+ 个函数使用不透明的 uint64_t 句柄 — 不需要 C++ 头文件。",
  ...
  "markup.reactiveMenuTitle": "反应式菜单 (1.6.0)",
